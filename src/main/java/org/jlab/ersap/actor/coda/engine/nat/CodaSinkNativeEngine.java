package org.jlab.ersap.actor.coda.engine.nat;
...
public class CodaSinkNativeEngine extends AbstractEventWriterService<FileWriter> {
    @Override
    ...
    protected EngineDataType getDataType() {
        return CodaTimeFrameDataType.CODA_TIME_FRAME;
    }
}
